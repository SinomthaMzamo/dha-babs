...
export class SlotService {
  ...
  private branchData = {
    ...
    branches: [
      // Gauteng branches
      { id: 'cresta', name: 'Cresta', cityId: 'johannesburg' },
      { id: 'johannesburg', name: 'Johannesburg', cityId: 'johannesburg' },
      { id: 'roodepoort', name: 'Roodepoort', cityId: 'johannesburg' },
      {
        id: 'pretoria-menlyn',
      ...
      { id: 'soweto', name: 'Soweto', cityId: 'soweto' },
      { id: 'springs', name: 'Springs', cityId: 'springs' },
      { id: 'vereeniging', name: 'Vereeniging', cityId: 'vereeniging' },
      { id: 'alberton', name: 'Alberton', cityId: 'alberton' },
      { id: 'benoni', name: 'Benoni', cityId: 'benoni' },
      { id: 'brakpan', name: 'Brakpan', cityId: 'brakpan' },
      { id: 'boksburg', name: 'Boksburg', cityId: 'boksburg' },
      { id: 'carletonville', name: 'Carletonville', cityId: 'carletonville' },
      { id: 'edenvale', name: 'Edenvale', cityId: 'edenvale' },
      { id: 'ga-rankawa', name: 'Ga-Rankuwa', cityId: 'ga-rankawa' },
      { id: 'heidelberg', name: 'Heidelberg', cityId: 'heidelberg' },
      { id: 'kempton-park', name: 'Kempton Park', cityId: 'kempton-park' },
      { id: 'mogale-city', name: 'Mogale City', cityId: 'mogale-city' },
      {
        id: 'hammanskraal-temba',
        name: 'Hammanskraal Temba',
        cityId: 'hammanskraal-temba',
      },
      { id: 'nigel', name: 'Nigel', cityId: 'nigel' },
      {
        id: 'medium-office-randburg',
        name: 'Medium Office Randburg',
      ...
      { id: 'tshwane', name: 'Tshwane', cityId: 'tshwane' },
      { id: 'randfontein', name: 'Randfontein', cityId: 'randfontein' },
      { id: 'centurion', name: 'Centurion', cityId: 'centurion' },
      { id: 'mamelodi-east', name: 'Mamelodi East', cityId: 'mamelodi-east' },
      { id: 'evaton', name: 'Evaton', cityId: 'evaton' },
      {
        id: 'bronkhorstspruit',
        name: 'Bronkhorstspruit',
      ...
      { id: 'khayelitsha', name: 'Khayelitsha', cityId: 'cape-town' },
      { id: 'nyanga', name: 'Nyanga', cityId: 'cape-town' },
      { id: 'wynberg', name: 'Wynberg', cityId: 'cape-town' },
      { id: 'somerset-west', name: 'Somerset West', cityId: 'cape-town' },
      { id: 'vredenburg', name: 'Vredenburg', cityId: 'cape-town' },
      // Bellville branches
      ...
      { id: 'vredendal', name: 'Vredendal', cityId: 'vredendal' },
      { id: 'grabouw', name: 'Grabouw', cityId: 'grabouw' },
      { id: 'george', name: 'George', cityId: 'george' },
      { id: 'paarl', name: 'Paarl', cityId: 'paarl' },
      { id: 'beaufort-west', name: 'Beaufort West', cityId: 'beaufort-west' },
      { id: 'caledon', name: 'Caledon', cityId: 'caledon' },
      {
        id: 'mitchells-plain',
        name: 'Mitchells Plain',
        cityId: 'mitchells-plain',
      },
      { id: 'malmesbury', name: 'Malmesbury', cityId: 'malmesbury' },
      { id: 'oudtshoorn', name: 'Oudtshoorn', cityId: 'oudtshoorn' },
      { id: 'worcester', name: 'Worcester', cityId: 'worcester' },
      { id: 'stellenbosch', name: 'Stellenbosch', cityId: 'stellenbosch' },
      { id: 'kwanonqaba', name: 'Kwanonqaba', cityId: 'kwanonqaba' },
      { id: 'prince-albert', name: 'Prince Albert', cityId: 'prince-albert' },
      { id: 'bredasdorp', name: 'Bredasdorp', cityId: 'bredasdorp' },
      { id: 'robertson', name: 'Robertson', cityId: 'robertson' },
      { id: 'ceres', name: 'Ceres', cityId: 'ceres' },
      {
        id: 'plettenburg-bay',
        name: 'Plettenburg Bay',
